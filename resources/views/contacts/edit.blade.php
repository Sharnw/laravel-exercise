            ...
            <div class="panel-body row">
                <div class="col-sm-12 col-md-10 col-lg-8">
                   ...
                   <hr>
        			...
        			<form class="form-horizontal" id="update_contact_form" @submit.prevent="updateContact">
            			...
            			<div class="panel panel-primary">
                            ...
                            <div class="panel-footer">
                               ...
                               <div>
                                    <ul>
                                        <li class="alert alert-danger" v-for="error in update_errors">@{{error}}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
	<script>
		var update_contact_form = new Vue({
            el: '#update_contact_form',
            data: {
            	contact: contact,
            	savingContact: false,
                update_errors: []
            ...
            methods: {
            	storeContact: function() {
            		...
            		let self = this;
                    axios.put('/contacts/'+this.contact.id+'/update', {contact: this.contact})
